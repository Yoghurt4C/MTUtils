...
public class MTHandlers {
    ...
    @ZenMethod
    public static int StringToInt(IFormattedText from) {
        return Integer.parseInt(FormattedTextToString(from));
    }
    ...
    @ZenMethod
    public static int FormattedTextToInt(IFormattedText from) {
        return StringToInt(FormattedTextToString(from));
    }

    @ZenMethod
    public static float FormattedTextToFloat(IFormattedText from) {
        return Float.parseFloat(FormattedTextToString(from));
    }

    @ZenMethod
    public static float StringToFloat(String from) {
    ...
    @ZenMethod
    public static String FormattedTextToString(IFormattedText text) {
        return ((FormattedString) text).getTooltipString();
    }

    @ZenMethod
    public static String FormattedStringToString(IMCFormattedString text) {
    ...
    @ZenMethod
    public static boolean isNull(IIngredient object) {
        return object == null;
    }

    @ZenMethod
    public static boolean isNull(IItemStack object) {
        return object == null;
    }

    @ZenMethod
    public static boolean isNull(IOreDictEntry object) {
        return object == null;
    }

    @ZenMethod
    public static IOreDictEntry getOreDictEntryFromString(String in) {
        return new MCOreDictEntry(OreDictionary.getOreID(in));
    }

    @ZenMethod
    public static IOreDictEntry getOreDictEntryFromString(IFormattedText in) {
        return getOreDictEntryFromString(FormattedTextToString(in));
    }

    @ZenMethod
    public static IOreDictEntry getOreDictEntryFromString(IMCFormattedString in) {
        return getOreDictEntryFromString(FormattedStringToString(in));
    }

    @ZenMethod
    public static IFormattedText StringToFormattedText(String in) {
        return new FormattedString(in);
    }

    @ZenMethod
    public static IMCFormattedString StringToFormattedString(String in) {
        return new FormattedString(in);
    }

    @ZenMethod
    public static void executeCommand(IFormattedText cmd) {
        executeCommand(FormattedTextToString(cmd));
    }
    ...
    @ZenMethod
    public static void addMultilineShiftTooltip(IItemStack stack, String strs) {
        addMultilineShiftTooltip(stack, StringToFormattedString(strs));
    }

    @ZenMethod
    public static void addMultilineShiftTooltip(IItemStack stack, String strs, String s) {
        addMultilineTooltip(stack, StringToFormattedString(strs), s);
    }
    ...
    public static void addMultilineShiftTooltip(IItemStack stack, IFormattedText strs, String s) {
        for (String str : split(FormattedTextToString(strs), s))
            IngredientTooltips.addShiftTooltip(stack, StringToFormattedString(str));
    }

    @ZenMethod
    public static void addMultilineTooltip(IItemStack stack, String strs, String s) {
        addMultilineTooltip(stack, StringToFormattedString(strs), s);
    }

    @ZenMethod
    public static void addMultilineTooltip(IItemStack stack, String strs) {
        addMultilineTooltip(stack, StringToFormattedString(strs));
    }
    ...
    public static void addMultilineTooltip(IItemStack stack, IFormattedText strs, String s) {
        for (String str : split(FormattedTextToString(strs), s))
            IngredientTooltips.addTooltip(stack, StringToFormattedString(str));
    }
    ...
    @ZenMethod
    public static IFormattedText[] split(IFormattedText str, String separator) {
    ...
    @ZenMethod
    public static String[] split(String original, String split) {
        if (split.length() == 1)
