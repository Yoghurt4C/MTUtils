...
public class PlayerDetector {
    private final HashMap<PlayerID, EntityPlayerMP> activePlayers = new HashMap<PlayerID, EntityPlayerMP>();
    private final HashSet<Acceptor<EntityPlayerMP>> onLogin = new HashSet<Acceptor<EntityPlayerMP>>();
    private final HashSet<Acceptor<EntityPlayerMP>> onLogout = new HashSet<Acceptor<EntityPlayerMP>>();
